...
class ElectricalEstimator:
    """Handles electrical quantity calculations"""
    ...
    def calculate_quantities(self, square_footage, tier, **kwargs):
        """Calculate electrical quantities based on inputs"""
    ...
    def _calculate_distribution(self, square_footage, tier):
        ...
        try:
            result["total_circuits"] = round(result["total_outlets_switches"] / circuits_per_device[tier])
        except:
            # If total_outlets_switches isn't defined yet
